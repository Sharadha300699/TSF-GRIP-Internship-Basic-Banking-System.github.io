...
<head>
    ...
    <title>T$F Bank- Create User</title>
...
?>
    ...
    <br><br><br>
     ...
     <section class="usercard">
             ...
             <div class="card-body bg-light">
                 <form action="" class="userform" method="post">
                   ...
                   <div class="text-center button">
                     <input type="submit" value="CREATE" name="submit" class="btn btn-warning" style="font-size:1.2rem; font-weight:bold ">
      ...
      padding-top: 35px;
      ">
       <p style="font-size: 20px;">© Copyright 2021. All Rights Reserved. Made by - <a href="https://www.linkedin.com/in/sharadha-k-02959515a/" target="_blank" style="color: gold; text-decoration: none;">SHARADHA K</a></p>
      </footer>
